...
case "$DISTRO" in
    arch)
        PACMAN_PACKAGES=("${COMMON_PACKAGES[@]}" alacritty code eza fastfetch font-manager libreoffice-fresh libreoffice-fresh-pl lm_sensors mousepad network-manager-applet nsxiv nwg-look mlocate os-prober polkit-gnome starship swappy tealdeer tlp wezterm wofi yazi)
        YAY_PACKAGES=(
