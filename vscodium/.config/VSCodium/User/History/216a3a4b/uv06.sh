...
case "$DISTRO" in
    arch)
        ...
        YAY_PACKAGES=(
        bibata-cursor-theme brother-dcp1610w brscan4 google-chrome grimblast-git moc-pulse mkinitcpio-firmware ookla-speedtest-bin simple-sddm-theme-git sublime-text-4 waypaper wlogout)
        ;;
    ubuntu)
