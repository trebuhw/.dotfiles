...
echo "Kopiowanie repozytorium .dotfiles..."
git clone --depth=1 https:github.com/trebuhw/.dotfiles.git ~/.dotfiles; cd ~/.dotfiles
git clone --depth=1 https://github.com/trebuhw/.hydedots.git ~/.hydedots; cd ~/.hydedots
