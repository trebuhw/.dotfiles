...
install_gui_deps() {
    ...
    sudo xbps-install -Sy base-devel libX11-devel libXinerama-devel libXft-devel nvidia nvidia-libs xorg xorg-server xinit wayland wayland-protocols xf86-input-synaptics xf86-video-intel xwayland wlroots libinput libdrm libgbm mesa-dri hyprland
...
PACKAGES=(
    ...
    alacritty vscode eza fastfetch font-manager libreoffice libreoffice-i18n-pl polkit-gnome network-manager-applet nsxiv mlocate os-prober sddm starship tldr tlp qt5ct wezterm yazi
    lm_sensors nwg-look simple-sddm-theme ueberzug waypaper
    foot waybar wofi swaybg grim slurp swaylock
)
