...
install_gui_deps() {
    ...
    sudo xbps-install -Sy base-devel libX11-devel libXinerama-devel libXft-devel nvidia nvidia-libs xorg xorg-server xinit wayland wayland-protocols xwayland wlroots libinput libdrm libgbm mesa-dri hyprland
