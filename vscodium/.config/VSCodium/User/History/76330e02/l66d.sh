...
arch_specific_configs() {
    ...
    [ -d /usr/share/sddm/themes/simple-sddm ] && mv /usr/share/sddm/themes/simple-sddm /usr/share/sddm/themes/simple-sddm.bak
    [ -f /etc/sddm.conf.d ] && mv /usr/share/sddm/themes/simple-sddm ~/gtk-4.0.bak
