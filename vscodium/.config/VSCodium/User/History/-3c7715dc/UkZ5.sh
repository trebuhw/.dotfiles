...
echo "1. Wszystkie pliki:"
find "$search_path" -type f | wc -l
echo "2. Z wykluczeniami .git:"
find "$search_path" -type f -not -path '*/\.git/*' | wc -l
echo "3. Z wykluczeniami .git i node_modules:"
find "$search_path" -type f -not -path '*/\.git/*' -not -path '*/node_modules/*' | wc -l
echo "4. Z wszystkimi wykluczeniami:"
find "$search_path" -type f -not -path '*/\.git/*' -not -path '*/node_modules/*' -not -path '*/.cache/*' 2>/dev/null | wc -l
