...
install_HYPRLAND_deps() {
    case "$DISTRO" in
        arch)
            ...
            sudo pacman -S --needed --noconfirm azotebg foot brightnessctl grim hyprland mako networkmanager qt5-wayland qt6-wayland slurp swaybg swayidle swaylock waybar wireplumber wl-clipboard xdg-desktop-portal-hyprland
            ;;
        ubuntu)
