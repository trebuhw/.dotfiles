...
install_HYPRLAND_deps() {
    case "$DISTRO" in
        arch)
            ...
            sudo pacman -S --needed --noconfirm hyprland waybar xdg-desktop-portal-hyprland qt5-wayland qt6-wayland wireplumber networkmanager swaybg swaylock swayidle wl-clipboard mako grim slurp brightnessctl 
            ;;
        ubuntu)
