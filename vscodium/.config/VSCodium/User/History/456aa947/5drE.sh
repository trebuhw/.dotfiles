...
case "$DISTRO" in
    arch)
        ...
        YAY_PACKAGES=(
        brother-dcp1610w brscan4 google-chrome grimblast-git mkinitcpio-firmware moc-pulse simple-sddm-theme-git waypaper wlogout
            )
        ;;
    ubuntu)
        PACMAN_PACKAGES=("${COMMON_PACKAGES[@]}" 
...
stow Xresources/ alacritty/ background/ bash/ bat/ bin/ btop/ dunst/ fish/ foot/ fonts/ gtk-2.0/ gtk-3.0/ gtk-4.0/ gtkrc-2.0/ hypr/ icons/ kitty/ mako/ mc/ mousepad/ nsxiv/ nvim/ qt5ct/ profile/ ranger/ rofi/ starship/ sublime-text/ swappy/ swaylock/ tldr/ themes/ thunar/ vim/ vscode/ waybar/ wezterm/ wlogout/ wofi/ wofifull/ xfce4/ yazi/ zathura/
