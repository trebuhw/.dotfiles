...
xsetroot -name " ${TEMP_ICON} ${TEMP}°C | ${CPU_ICON} ${CPU}% | ${RAM_ICON} ${RAM} | ${VOL_ICON} ${VOL} | ${BT_ICON} ${BT} | ${NET_ICON} ${NET} | ${BAT_ICON} ${BAT} | ${DATE} "
sleep 4
done
EOF
