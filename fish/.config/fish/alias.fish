...
alias oiw="$HOME/.config/suckless/scripts/ostatnie-instalacje-wieksze.sh"
alias oim="$HOME/.config/suckless/scripts/ostatnie-instalacje-mniejsze.sh"
alias oip="$HOME/.config/suckless/scripts/ostatnie-instalacje-od-do.sh"
alias oiz="$HOME/.config/suckless/scripts/ostatnie-instalacje-z-dnia.sh"
